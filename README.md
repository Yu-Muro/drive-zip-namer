...
1. Google Drive でダウンロードしたいファイルを選択する
2. ツールバーの Drive Zip Namer アイコンをクリックし、ZIP ファイル名を入力して
   **「次の Drive ダウンロードに適用」** を押す
3. いつもどおり Google Drive の「ダウンロード」を実行する
4. 指定した名前（例: `2026-07-24_納品データ.zip`）で保存される
